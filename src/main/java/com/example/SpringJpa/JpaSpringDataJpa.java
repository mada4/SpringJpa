...
public class JpaSpringDataJpa implements CommandLineRunner {
        ...
        do {
            ...
            switch (opt)
            {
                case 0:
                    exit(0);
                    break;
                case 1:System.out.println("Masina: " + repo.insert(new Masini("TM13CKY", "Renault", 2013, "negru", 8000)) + " a fost inserata");
                    break;
                case 2:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    repo.findMasiniNoi(LocalDate.now().getYear()).forEach(System.out::println);
                    break;
            }
        }while(opt!=0);
    }
